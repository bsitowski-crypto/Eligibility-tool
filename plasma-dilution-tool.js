...
`;
  ...
  function addFluid(category,focus=true){
    ...
    function applyDefault(){const item=engine.COMPONENTS[component.value],custom=row.querySelector(".pd-custom-component-wrap");volume.value=item?.volume??"";custom.hidden=component.value!=="other_crystalloid";update();}
