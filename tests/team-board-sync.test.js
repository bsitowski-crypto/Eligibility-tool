...
test('integration is outside donor rendering, loaded in order, and cached',()=>{
  ...
  assert.ok(index.includes('team-board-model.js?v=9191'));assert.ok(index.includes('team-board.js?v=9194'));
  for(const file of ['team-board-model.js','team-board.js'])assert.ok(sw.includes(`"./${file}"`));
  assert.ok(ui.includes("desktop-home.js?v=9194"));
